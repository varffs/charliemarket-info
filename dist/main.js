...
function getTotalWidth(items) {
  ...
  items.each(function (index, item) {
    width += jquery__WEBPACK_IMPORTED_MODULE_1___default()(item).outerWidth(true);
  });
  return width;
}
function layout() {
...
function bind() {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.cm-gallery .cm-gallery__item').on('click', function (event) {
    ...
    targetIndex === currentIndex && targetIndex === galleryLength - 1) {
      targetIndex = 0;
    }
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.cm-gallery__image').one('load', function (event) {
    ...
    if (this.complete) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).trigger('load');
    }
  });
});
}();
